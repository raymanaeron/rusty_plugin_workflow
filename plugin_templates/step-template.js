...
function initializeWebSocket() {
    ...
    ws.onopen = () => {
        ws.send('register-name:{{plugin_route}}_ui');
        console.log('[{{plugin_route}}] Connected to WebSocket server');
    };

    ws.onerror = (error) => {
        console.error('[{{plugin_route}}] WebSocket error:', error);
    };

    ws.onclose = () => {
        console.log('[{{plugin_route}}] Disconnected from WebSocket server');
